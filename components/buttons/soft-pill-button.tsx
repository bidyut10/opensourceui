    ...
    return (
      <button
        ...
        className={cn(
          ...
          "transition-[background-color,box-shadow,color,translate] duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-[background-color,box-shadow,color]",
