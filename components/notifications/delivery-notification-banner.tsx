    ...
    return (
      ...
      >
        <button
          ...
          className="absolute top-2 right-2 flex size-6 cursor-pointer items-center justify-center rounded-full text-neutral-400 transition-[color,background-color,scale] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] hover:bg-black/5 hover:text-neutral-600 active:scale-[0.97] motion-reduce:transition-colors motion-reduce:active:scale-100"
        >
          <X size={10} />
        </button>
