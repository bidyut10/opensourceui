      ...
      <div className="flex w-full min-w-0 flex-col items-center gap-6 px-3 md:px-4">
        ...
        <div className="my-10 max-w-xl px-4 md:px-0">
          ...
          <Paragraph>
            ...
            finishes. Drop in complications, fitness rings, or now-playing
            screens — and present wrist UI that feels native, not pasted on.
          </Paragraph>
        </div>
        ...
        >
          ...
          <Paragraph>
            Explore carefully designed clock variants that balance
            functionality, elegance, and customization for any project.
          </Paragraph>
        ...
        >
          ...
          <Paragraph>
            Polished widgets inspired by modern design systems, built with
            smooth interactions and thoughtful details that users notice.
          </Paragraph>
          <div className="mt-16 flex flex-col items-center justify-between gap-6 md:flex-row">
            <BluetoothFaceWidget />
            <TorchFaceWidget />
        ...
        <div className="relative mt-36 max-w-xl px-4 md:px-0">
          ...
          <Paragraph>
            ...
            for icons. Every file is production-ready, readable, and yours to
            own.
          </Paragraph>
          <div className="mt-16">
        ...
        <div className="relative mt-36 max-w-xl px-4 md:px-0">
          ...
          <Paragraph>
            Tools, people, and services that power {siteConfig.displayName} —
            plus a spot for sponsors who want to support the project.
          </Paragraph>
          <OpenSourcePanel />
        </div>
